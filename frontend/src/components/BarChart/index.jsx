...
const chartOption = {
    ...
    plugins: {
        tooltip: { // tooltip é o que exibe informações do gráfico no hover, aqui eu estou permitindo um retorno que mostra a quantidade de incrições feitas que está armazenado na coluna y originalmente informada pelo array "arrIncricaoFrei"
            callbacks: {
